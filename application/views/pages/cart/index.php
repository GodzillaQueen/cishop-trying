							...
							<?php foreach($content as $row) : ?>
                                <tr>
                                    <td>
										...
										base_url('images/product/default.png') ?>" alt="" height="50"><strong><?= $row->title ?></strong></p>
                                    </td>
                                    ...
                                    <td>
										...
										<input type="hidden" name="id" value="<?= $row->id ?>">
                                            <button class="btn btn-danger " type="submit"onclick="return confirm('Apakah kamu yakin ingin menghapus?')"><i class="fas fa-trash-alt"></i></button>
                                        </form>
                                    </td>
                                </tr>
							<?php endforeach ?>
