                ...
                <div class="card-body">
					...
					<?= isset($input->id) ? form_hidden('id',$input->id) : '' ?>
                        ...
                        <div class="form-group">
							...
							['id', 'title']), $input->id_category,['class' => 'form-control']) ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
								...
								'checked' => $input->is_available == 1 ? true : false, 'form-check-input']) ?>
                                <label for="" class="form-check-label">Tersedia</label>
                            </div>
                            <div class="form-check form-check-inline">
							<?= form_radio(['name' => 'is_available', 'value' => 0, 
								'checked' => $input->is_available == 0 ? true : false, 'form-check-input']) ?>
                        ...
                        <div class="form-group">
							...
							<?php if($this->session->flashdata('image_error')): ?>
								...
								$this->session->flashdata('image_error') ?></small>
								<?php endif ?>
								<?php if($input->image) : ?>
